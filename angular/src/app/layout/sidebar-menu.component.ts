...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            new MenuItem(this.l('Doctor'), '/app/docter', 'fas fa-info-circle'),
            new MenuItem(this.l('Patient'), '/app/patient', 'fas fa-info-circle'),
            new MenuItem(this.l('PatientAdmission'), '/app/patientAdmission', 'fas fa-info-circle'),
            new MenuItem(this.l('Room'), '/app/room', 'fas fa-info-circle'),
             new MenuItem(this.l('Bed'), '/app/bed', 'fas fa-info-circle'),
